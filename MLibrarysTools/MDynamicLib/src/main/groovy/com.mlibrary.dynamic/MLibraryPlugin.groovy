...
public class MLibraryPlugin implements Plugin<Project> {
    public static String pluginName = "dynamicLibrary"
    private Project project;
    private Project applicationProject = null;

    private MLibraryExtension libraryExtension;
    ...
    private MLibraryExtension parentLibraryExtension = null

    @Override
    public void apply(Project project) {
        this.project = project;
        libraryExtension = project.extensions.create(pluginName, MLibraryExtension.class)
