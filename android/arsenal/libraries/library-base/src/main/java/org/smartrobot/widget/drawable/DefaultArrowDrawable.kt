 ...
 */
package org.smartrobot.widget.drawable
...
class DefaultArrowDrawable @JvmOverloads constructor(resources: Resources, private val rounded: Boolean = false) : Drawable() {
     ...
     */
    private class JoinedPath private constructor(pathFirst: Path, pathSecond: Path) {
         ...
         */
        private fun getPointOnLine(parameter: Float, coords: FloatArray) {
    ...
    private inner class BridgingLine private constructor(private val pathA: JoinedPath, private val pathB: JoinedPath) {
    ...
    companion object {
        ...
        /** Paths were generated with at this size for [DefaultArrowDrawable.PATH_GEN_DENSITY].  */
         ...
         * [DefaultArrowDrawable.PATH_GEN_DENSITY], no scaling needs to be done.
         */
